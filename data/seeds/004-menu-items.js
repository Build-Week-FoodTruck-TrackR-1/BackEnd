  ...
  return knex('menu_items').del()
    .then(function () {
      ...
      return knex('menu_items').insert([
        ...
        {name: 'carne asada taco', price: 2.00, category: 'entree', truck_id: 2},
        {name: 'carne asada burrito', price: 8.50, category: 'entree', truck_id: 2},
        {name: 'torta de al pastor', description: 'big sandwich with steak, lettuce, tomtoes, onions, mayo and salsa', price: 8.00, category: 'entree', truck_id: 2},
